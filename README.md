...
[![codecov](https://codecov.io/gh/puchunim/api-test/branch/main/graph/badge.svg?token=api-test_token_here)](https://codecov.io/gh/puchunim/api-test)
[![CI](https://github.com/puchunim/api-test/actions/workflows/main.yml/badge.svg)](https://github.com/puchunim/api-test/actions/workflows/main.yml)

Awesome api_test created by puchunim

## Install

from source
```bash
git clone https://github.com/puchunim/api-test api_test
cd api_test
make install
```
...
```bash
$ api_test run --port 8080
```

or

```bash
python -m api_test run --port 8080
```
...
```bash
❯ api_test --help
Usage: api_test [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ api_test create-user --help
Usage: api_test create-user [OPTIONS] USERNAME PASSWORD
...
```bash
api_test create-user admin admin --superuser
```
...
Run with `api_test run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `api_test create-user`.
...
-----------------------------------------------------
api_test/__init__.py              4      0   100%
api_test/app.py                  16      1    94%
api_test/cli.py                  21      0   100%
api_test/config.py                5      0   100%
api_test/db.py                   10      0   100%
api_test/models/__init__.py       0      0   100%
api_test/models/content.py       47      1    98%
api_test/routes/__init__.py      11      0   100%
api_test/routes/content.py       52     25    52%
api_test/routes/security.py      15      1    93%
api_test/routes/user.py          52     26    50%
api_test/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in api_test/default.toml.
